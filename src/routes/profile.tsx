...
function ProfileInner() {
  ...
  // Auto-sync loyalty points from the Kick-app endpoint configured in
  // src/config/site.ts (VITE_POINTS_SYNC_URL). Returns null when not
  // configured so we cleanly fall back to profile.gems.
